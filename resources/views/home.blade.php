                        ...
                        -->
                            ...
                            <li class="scroll-to-section">
                                    ...
                                    @guest
                                        ...
                                        <li class="scroll-to-section mt-2">Cart[0]</li>
                                    @endguest
                ...
                <div class="col-lg-4">
                    <div class="left-content">
                        <div class="inner-content">
                            <h4>BEST KHADOK</h4>
                            <h6>WITH THE BEST EXPERIENCE</h6>
                            <div class="main-white-button scroll-to-section">
                                <input type="text" placeholder="Search Your Desire Food"
                                style="width: 70pxpx; height:40px; padding:10px; margin-bottom:10px;">
                                <a href="#reservation"> Search here</a>
                            </div>
                        </div>
                    </div>
                </div>
