...
-->
    ...
    <header class="header-area header-sticky">
        ...
        {{-- Table Part --}}
                    ...
                    <table class="table table-stripped bg-seccondary mt-5" >
                        <tr >
                            <th>Id</th>
                            <th>Food Name</th>
                            <th>Price</th>
                        ...
                        @foreach ($data1 as $data1 )
                                ...
                                <td >
                                    ...
                                    <a href="{{url('/remove',$data1->id)}}" type="button" class="btn btn-danger m-4">Remove</a>
                                </td> 
            ...
            <div align="center" style="padding: 10px" >
                ...
                <button type="submit" class="btn btn-success" > Oder Confirm </button>
